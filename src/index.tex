...
\begin{description}
    ...
    \item[\texttt{SC2154}] --
        Ez a szabály szól, ha definiálatlan változót akarunk használni (ha az nem csupa nagybetűs).
...
Ezután következnek azok a függvények, melyek függnek a konfigurációs értékektől.
Például:

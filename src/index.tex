...
\todo[inline,color=red,textcolor=white]{git commitok tartalma röviden}
...
\todo[inline,color=red,textcolor=white]{általános leírás vége}
...
\todo[inline,color=red,textcolor=white]{bevezetés a git tárolási modelljéhez}
...
\begin{description}
    ...
    \item[\textit{annotated tag}:]
        Nevesített permanens címke, de metaadatokkal kiegészítve (például leírás).
        A Git a lightweight tagektől eltérően kezeli.
\end{description}

\todo[inline,color=red,textcolor=white]{további git terminológiák}

\todo[inline,color=red,textcolor=white]{a git tárolási modelljének részletei}

\section{Tárolók átfogó állapotának kezelése}

\todo[inline,color=red,textcolor=white]{a git átfogó állapotairól}
...
\todo[inline,color=red,textcolor=white]{a git-chord megközelítéséről}
% mentális modell
% a git szisztémájának természetes használata a háttérben

\section{Speciális esetek a Git Chord-ban}

\todo[inline,color=red,textcolor=white]{speciális esetek}
...
\todo[inline,color=red,textcolor=white]{webes felület szerverének indítása}

\subsection{A felület kezelése}

\todo[inline,color=red,textcolor=white]{webes felület kezelése}

\subsection{Használat IDE kiterjesztésként}

\todo[inline,color=red,textcolor=white]{használat IDE-kben}
...
\todo[inline,color=red,textcolor=white]{a szkript főrészét részletezni}
...
\todo[inline,color=red,textcolor=white]{további megjegyzések a repóhoz}

\section{A Git Chord webes felületének felépítése}

\subsection{A forrásrepó és a brackend felépítése}

\todo[inline,color=red,textcolor=white]{webes forrásrepó és backend}

\subsection{A frontend alkalmazás felépítése}

\todo[inline,color=red,textcolor=white]{frontend}

\subsection{Az IDE kiterjesztések specialitásai}

\todo[inline,color=red,textcolor=white]{IDE extensionök}
...
\todo[inline,color=red,textcolor=white]{általános értékelés}

\section{A Git Chord fő használati esetei}

\todo[inline,color=red,textcolor=white]{fő használati esetek}

\section{A Git Chord használata verziókezelő rendszerek oktatásában}

\todo[inline,color=red,textcolor=white]{használat az oktatásban}
...
\todo[inline,color=red,textcolor=white]{tesztesetek a test könyvtár alapján}

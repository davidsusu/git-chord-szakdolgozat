...
egy-egy snapshotja, azazpillanatképe jelenti az atomi egységet.
...
A modern rendszerekben a párhuzamos fejlesztés külön brancheken, azaz ágakon párhuzamosan történik.
...
A Git tehát pillanatképekben tárolja a történetet, nem különbség-fájlok (diffek) formájában.
...
A Git modelljénet vázlatosan mutatja be a(z) \ref{fig:git-dag} ábra.
...
ágak közötti kapcsolatok stb.

TODO: a git átfogó állapotairól
(a subversion stb. még egy nagy (idődimenzióval kiegészített) fájlrendszerben tárolta az ágakat is,
valójában nincs beépített ágkezelés, az ágak egyszerűen külön könyvtárakban vannak,
...
TODO: a git-chord megközelítéséről
(mentális modell;
...
TODO: webes felület szerverének indítása

\subsection{A felület kezelése}

TODO: webes felület kezelése
...
TODO: általános értékelés

\section{A Git Chord fő használati esetei}

TODO: fő használati esetek

\section{A Git Chord használata verziókezelő rendszerek oktatásában}

TODO: használat az oktatásban

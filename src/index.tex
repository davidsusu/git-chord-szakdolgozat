...
\caption{A \texttt{git-chord} fő shell szkriptjének magas szintű vezérlési folyamata}
...
\begin{itemize}
    ...
    \item (teljesen vagy feltételesen) tárolófüggetlen alparancsok kiszolgálása (help, version, default-kezelés stb.)
    \item Git tároló ellenőrzése
    \item tárolófüggő alparancsok kiszolgálása
\end{itemize}
...
A gyakorlatban komoly viták vannak akörül, végül is mit érdemes megadni,

...
Mind a Git szervert, mind a lokális másolatot szokás repositorynak (néha röviden \textit{repó}nak), azaz tárolónak nevezni.
...
Elsőként a \textit{commit} művelettel létrehozzuk az új tárolt állapotot;
a bevett terminológia szerint ezt is commitnak nevezik.

TODO: git commitok tartalma röviden

Alapértelmezetten az aktuális ág mentett állapota egyúttal az újonnan létrejött commitra ugrik.
...
Amikor a \textit{clone} művelettel lemásolunk, leklónozunk egy tárolót,
alapértelmezetten az összes ág és címke letöltésre kerül a teljes történettel együtt.

TODO: általános leírás vége
...
\section{A Git modellje, szakkifejezések}

TODO: bevezetés a git tárolási modelljéhez
...
A kifejezések jegyzékét a(z) \ref{tab:git-terminologia}. táblázat tartalmazza.
...
TODO: további git terminológiák

TODO: a git tárolási modelljének részletei
...
\begin{figure}[H]
\centering
\includesvg[width=\textwidth,height=0.75\textheight,keepaspectratio]{images/git-chord-flow}
...
\begin{figure}[h]
\centering
\includesvg[width=\textwidth,height=0.75\textheight,keepaspectratio]{images/git-chord-args-flow}
